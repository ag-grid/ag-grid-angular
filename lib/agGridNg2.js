...
var AgGridNg2 = (function () {
    function AgGridNg2(elementDef) {
        ...
        ag_grid_1.ComponentUtil.EVENTS.forEach(function (eventName) {
    ...
    AgGridNg2.prototype.ngOnInit = function () {
        this.gridOptions = ag_grid_1.ComponentUtil.copyAttributesToGridOptions(this.gridOptions, this);
        var nativeElement = this.elementDef.nativeElement;
        var globalEventLister = this.globalEventListener.bind(this);
        new ag_grid_1.Grid(nativeElement, this.gridOptions, globalEventLister);
    ...
    AgGridNg2 = __decorate([
        core_1.Component({
            ...
            outputs: ag_grid_1.ComponentUtil.EVENTS,
            inputs: ag_grid_1.ComponentUtil.ALL_PROPERTIES.concat(['gridOptions']),
            template: '',
